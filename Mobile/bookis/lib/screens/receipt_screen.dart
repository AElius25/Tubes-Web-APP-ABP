...
class ReceiptScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      _ReceiptRow(
                          label: 'Subtotal',
                          value: fmt.format(transaction.subtotal)),
                      ...
                      if (transaction.tax > 0)
                        _ReceiptRow(
                            label: 'Pajak', value: fmt.format(transaction.tax)),
                      const Divider(),
                      _ReceiptRow(
                          label: 'TOTAL',
                          value: fmt.format(transaction.total),
                          isBold: true),
                      ...
                      const Center(
                          child: Column(children: [
                        Text('Terima kasih sudah membeli di Kedai Buku!',
          ...
          pw.Page(
            ...
            build: (pw.Context ctx) => pw.Column(
              ...
              children: [
                ...
                pw.Text('Toko Buku', style: const pw.TextStyle(fontSize: 10)),
                ...
                pw.Text('Terima kasih sudah membeli di Kedai Buku!',
  ...
  pw.Widget _pdfRow(String label, String value, {bool bold = false}) => pw.Row(
        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
        children: [
          pw.Text(label,
              style: pw.TextStyle(
