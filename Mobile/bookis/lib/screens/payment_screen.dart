...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  double get _paidAmount =>
      double.tryParse(_cashController.text.replaceAll(RegExp(r'[^\d]'), '')) ??
      0;
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    const Divider(),
                    _SummaryRow(
                        label: 'Subtotal', value: fmt.format(cart.subtotal)),
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      final amountPaid =
          _selectedMethod == PaymentMethod.cash ? _paidAmount : cart.total;
